...
<body>
  ...
  <header class="py-3 mb-3 border-bottom">
    <div class="container-fluid d-grid gap-3 align-items-center" style="grid-template-columns: 1fr 2fr;">
	  ...
	  <form action="store_board_search.php" method="get" role="search">
        ...
        <?php
          if(!empty($_SESSION['store_id'])){
            echo("<button onclick=\"location.replace('form.php');\">게시글 등록</button>");
          }
        ?>
  ...
  <?php    
    $sql = "SELECT * FROM store_board LEFT JOIN store on store.store_id = store_board.id 
          WHERE store_name LIKE '%$search1%' ORDER BY store_id DESC";	    // 가게이름 검색
